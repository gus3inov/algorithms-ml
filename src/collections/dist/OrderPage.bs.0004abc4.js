...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../node_modules/bs-platform/lib/js/block.js":[function(require,module,exports) {
'use strict';
...
},{"./curry.js":"../node_modules/bs-platform/lib/js/curry.js","process":"C:/Users/user/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/process/browser.js"}],"../node_modules/bs-platform/lib/js/caml_sys.js":[function(require,module,exports) {
var process = require("process");
'use strict';
...
},{"./caml_builtin_exceptions.js":"../node_modules/bs-platform/lib/js/caml_builtin_exceptions.js","process":"C:/Users/user/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/process/browser.js"}],"../node_modules/bs-platform/lib/js/caml_bytes.js":[function(require,module,exports) {
'use strict';
...
},{"./caml_builtin_exceptions.js":"../node_modules/bs-platform/lib/js/caml_builtin_exceptions.js"}],"../node_modules/bs-platform/lib/js/caml_string.js":[function(require,module,exports) {
'use strict';
  ...
  if (results !== null) {
    ...
    if (match !== undefined) {
      return (
        ...
        Block.__(0, [
        /* tuple */
        [Caml_format.caml_int_of_string(Caml_array.caml_array_get(results, 1)), match]])
      );
    } else {
      return (
        /* Error */
...
function calculateTotalShirts(orders) {
  var adder = function adder(accumulator, optOrder) {
    if (optOrder.tag) {
      return accumulator;
    } else {
...
function calculateTotals(orders) {
  var adder = function adder(accumulator, optOrder) {
    if (optOrder.tag) {
      ...
      return (
        /* tuple */
        [accumulator[0] + n | 0, accumulator[1] + orderPrice(
        /* tuple */
        [n, match[1]])]
      );
    }
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "10532" + '/');
...
},{}]},{},["C:/Users/user/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","OrderPage.bs.js"], null)
//# sourceMappingURL=/OrderPage.bs.0004abc4.map